...
def main():
    ...
    x = int((70-len('BOOM! - %s wurde getroffen!' % ('self.name')) - 2)/2)
    print(x)
    print(Color('{autobgred}{autowhite}#{/white}{/bgred}' * 70))
    print(Color('{autobgred}{autowhite}#{/white}{/bgred}' * x), Color('{autobgred}{autowhite}BOOM! - %s wurde getroffen!{/white}{/bgred}' % ('self.name')), Color('{autobgred}{autowhite}#{/white}{/bgred}') * x)
    print(Color('{autobgred}{autowhite}#{/white}{/bgred}' * 70))
    ...
    print(Color('{autobgblack}{autocyan}Cyan{/cyan}{/bgblack} {autobgblack}{autowhite}LUTZ1{/white}{/bgblack}'))
    ...
    print(Color('{autobgred}{autocyan}Cyan{/cyan}{/bgred} {autobgred}{autowhite}LUTZ2{/white}{/bgred}'))
    ...
    print(Color('{autobggreen}{autocyan}Cyan{/cyan}{/bggreen} {autobggreen}{autowhite}LUTZ3{/white}{/bggreen}'))
    ...
    print(Color('{autobgyellow}{autocyan}Cyan{/cyan}{/bgyellow} {autobgyellow}{autowhite}LUTZ4{/white}{/bgyellow}'))
    ...
    print(Color('{autobgblue}{autocyan}Cyan{/cyan}{/bgblue} {autobgblue}{autowhite}LUTZ5{/white}{/bgblue}'))
    ...
    print(Color('{autobgmagenta}{autowhite}LUTZ6{/white}{/bgmagenta}'))
    ...
    print(Color('{autobgcyan}{autocyan}Cyan{/cyan}{/bgcyan} {autobgcyan}{autowhite}LUTZ7{/white}{/bgcyan}'))
    ...
    print(Color('{autobgwhite}{autocyan}Cyan{/cyan}{/bgwhite} {autobgwhite}{autowhite}LUTZ8{/white}{/bgwhite}'))
    print()
    ...
    print(Color('{hicyan}Cyan{/cyan} {hiwhite}LUTZ9{/white}'))
    ...
    print(Color('{hibgblack}{hicyan}Cyan{/cyan}{/bgblack} {hibgblack}{hiwhite}LUTZ10{/white}{/bgblack}'))
    ...
    print(Color('{hibgred}{hicyan}Cyan{/cyan}{/bgred} {hibgred}{hiwhite}LUTZ11{/white}{/bgred}'))
    ...
    print(Color('{hibggreen}{hicyan}Cyan{/cyan}{/bggreen} {hibggreen}{hiwhite}LUTZ12{/white}{/bggreen}'))
    ...
    print(Color('{hibgyellow}{hicyan}Cyan{/cyan}{/bgyellow} {hibgyellow}{hiwhite}LUTZ13{/white}{/bgyellow}'))
    ...
    print(Color('{hibgblue}{hicyan}Cyan{/cyan}{/bgblue} {hibgblue}{hiwhite}LUTZ14{/white}{/bgblue}'))
    ...
    print(Color('{hibgmagenta}{hiwhite}LUTZ{/white}{/bgmagenta}'))
    ...
    print(Color('{hibgcyan}{hicyan}Cyan{/cyan}{/bgcyan} {hibgcyan}{hiwhite}LUTZ15{/white}{/bgcyan}'))
    ...
    print(Color('{hibgwhite}{hicyan}Cyan{/cyan}{/bgwhite} {hibgwhite}{hiwhite}LUTZ16{/white}{/bgwhite}'))
    print()
    ...
    print(Color('{blue}Blue{/blue} {magenta}Magenta{/magenta} {cyan}Cyan{/cyan} {white}LUTZ{/white}'))
    ...
    print(Color('{bgblack}{cyan}Cyan{/cyan}{/bgblack} {bgblack}{white}LUTZ17{/white}{/bgblack}'))
    ...
    print(Color('{bgred}{cyan}Cyan{/cyan}{/bgred} {bgred}{white}LUTZ18{/white}{/bgred}'))
    ...
    print(Color('{bggreen}{cyan}Cyan{/cyan}{/bggreen} {bggreen}{white}LUTZ19{/white}{/bggreen}'))
    ...
    print(Color('{bgyellow}{cyan}Cyan{/cyan}{/bgyellow} {bgyellow}{white}LUTZ20{/white}{/bgyellow}'))
    ...
    print(Color('{bgblue}{cyan}Cyan{/cyan}{/bgblue} {bgblue}{white}LUTZ21{/white}{/bgblue}'))
    ...
    print(Color('{bgmagenta}{cyan}Cyan{/cyan}{/bgmagenta} {bgmagenta}{white}LUTZ22{/white}{/bgmagenta}'))
    ...
    print(Color('{bgcyan}{cyan}Cyan{/cyan}{/bgcyan} {bgcyan}{white}LUTZ23{/white}{/bgcyan}'))
    ...
    print(Color('{bgwhite}{cyan}Cyan{/cyan}{/bgwhite} {bgwhite}{white}LUTZ24{/white}{/bgwhite}'))
