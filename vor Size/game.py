...
predefined_tanks = {   # Name, (mod_armor, mod_ammo, mod_power, mod_dmg_mitigation)
    '1': ('Heavy Tank', (115, 14, 15, 16)), #, 80)),
    '2': ('Middle Tank', (120, 14, 14, 18)), #, 50)),
    '3': ('Light Tank', (100, 10, 10, 10)), #, 20)),
    '4': ('UltraLight Tank', (100, 10, 10, 10)), #, 10)),
}
...
def select_tank(name):
    print('\n', str(name), 'select your tank:\n')
    try:
        tank_table = [  ['#', 'NAME',                   'Armor',                     'Ammo',                      'Power',                      'Damage mitigation',         'Size']]
                        # ['1', predefined_tanks['1'][0], predefined_tanks['1'][1][0], predefined_tanks['1'][1][1], predefined_tanks['1'][1][2], predefined_tanks['1'][1][3], predefined_tanks['1'][1][4]],
                        # ['2', predefined_tanks['2'][0], predefined_tanks['2'][1][0], predefined_tanks['2'][1][1], predefined_tanks['2'][1][2], predefined_tanks['2'][1][3], predefined_tanks['2'][1][4]],
                        # ['3', predefined_tanks['3'][0], predefined_tanks['3'][1][0], predefined_tanks['3'][1][1], predefined_tanks['3'][1][2], predefined_tanks['3'][1][3], predefined_tanks['3'][1][4]],
                        # ['4', predefined_tanks['4'][0], predefined_tanks['4'][1][0], predefined_tanks['4'][1][1], predefined_tanks['4'][1][2], predefined_tanks['4'][1][3], predefined_tanks['4'][1][4]],
        for entry in range(1, len(predefined_tanks) + 1):
            temp = []
            temp = [str(entry), predefined_tanks[str(entry)][0]]
            for i in range(len(predefined_tanks[str(entry)][1]) - 1):
        ...
        for counter, playersname in enumerate(players):
            ...
            while choice is None:
                ...
                if choice.lower() == 'm':
                    ...
                    attributes = select_tank(playersname)
                else:
                    choice = None
